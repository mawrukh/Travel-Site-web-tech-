...
<body>
    ...
    <nav class="navbar navbar-inverse  navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Visit Japan</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="./">Blog1 <span class="sr-only">(current)</span></a></li>
                    <li><a href="/home">BacktoSite</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 post-title-block">
                    ...
                    <h1 class="text-center">Travel to Tokyo</h1>
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <p class="lead">Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus
                    ...
                    <blockquote>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.
                            nascetur ridiculus mus. Donec ullamcorper nulla non metus auctor fringilla. Duis mollis, est
    ...
    <section class="footer-link"><a href="">Created by Mahrukh</a></section>

</body>

</html><?php /**PATH C:\Users\PC\proj1\travelSite\resources\views/blogs.blade.php ENDPATH**/ ?>